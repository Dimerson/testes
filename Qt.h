namespace Qt
{
	enum Key
	{
		...
		Key_MediaPause = 0x1000085,		//A key setting the state of the media player to pause (Note: not the pause/break key)
		Key_MediaTogglePlayPause = 0x1000086,	//A key to toggle the play/pause state in the media player (rather than setting an absolute state)
		...
		Key_Call = 0x01100004,			//A key to answer or initiate a call
		Key_Camera = 0x01100020,		//A key to activate the camera shutter
		Key_CameraFocus = 0x01100021,		//A key to focus the camera
		Key_Context1 = 0x01100000,
		Key_Context2 = 0x01100001,
		Key_Context3 = 0x01100002,
		Key_Context4 = 0x01100003,
		Key_Flip = 0x01100006,
		Key_Hangup = 0x01100005,		//A key to end an ongoing call
		Key_No = 0x01010002,
